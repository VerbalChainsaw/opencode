export const dict = {
  ...
  "session.goal.controlsHint": "Open a session to control the goal, or use chat: /goal pause · /goal resume · /goal clear",
  ...
  "session.goal.create.templates": "Or start from a template",
  ...
  "session.goal.steps.placeholder": "Describe a sub-goal…",
  "session.goal.steps.empty": "Break this goal into ordered sub-goals.",
