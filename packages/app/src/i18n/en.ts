export const dict = {
  ...
  "home.header.subtitle": "Projects, sessions, goals — one control room.",
  ...
  "home.sessions.liveBoard": "Live board",
  "home.sessions.projectBoard": "{{project}} sessions",
  ...
  "home.attention.title": "Attention queue",
  "home.attention.subtitle": "Sessions and goals waiting on you.",
  ...
  "session.goal.template.disabled.builtinTemplate": "Built-in actions are locked. Duplicate one to edit or delete a project copy.",
  ...
  "session.goal.interrupt.pausePermission": "Paused the goal and aborted the active turn. A permission prompt was pending; resolve or dismiss it before resuming.",
  "session.goal.interrupt.stopPermission": "Stopped the goal and aborted the active turn. A permission prompt was pending and may still need to be resolved or dismissed.",
  "session.goal.interrupt.pauseQuestion": "Paused the goal and aborted the active turn. A question prompt was pending; answer or dismiss it before resuming.",
  "session.goal.interrupt.stopQuestion": "Stopped the goal and aborted the active turn. A question prompt was pending and may still need to be answered or dismissed.",
  ...
  "session.goal.run.deliveryFailed": "Saved, but the run prompt didn't reach the session — the goal was paused. Resume to retry.",
  ...
  "session.goal.diagnostics.reason.liveGoal": "A live goal is already running. Pause, stop, or finish it before starting another.",
  "session.goal.diagnostics.reason.pendingHandoff": "A handoff is already pending. Claim or clear it before saving another.",
  ...
  "session.goal.chainBuilder.emptyChainDesc": "No chain items are required. Start Goal runs the goal above; add actions only when this goal needs a sequence.",
  "session.goal.chainBuilder.emptyChainNote": "Chain item edits stay local. Reorder, remove, turns, minutes, prompt, and command edits do not start a turn until Start Chain.",
  ...
  "session.goal.action.confirmResetHint": "This clears the live goal, chain, handoff, and activity. Templates and history are kept.",
