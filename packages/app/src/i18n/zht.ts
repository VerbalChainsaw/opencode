...
export const dict = {
  ...
  "prompt.placeholder.design": "隨便問點什麼，輸入 / 查看指令，輸入 @ 新增內容…",
  ...
  "prompt.toast.abortFailed.title": "停止工作階段失敗",
  ...
  "home.project.newSessionIn": "在 {{project}} 中新增工作階段",
  "home.sessions.search.placeholder": "搜尋最近工作階段",
  "home.sessions.search.sessions": "工作階段",
  "home.sessions.search.noResults": "找不到與 {{query}} 相關的工作階段",
  "home.sessions.empty": "找不到工作階段",
  "home.sessions.empty.description": "為這個專案開始新的工作階段",
  "home.sessions.group.today": "今天",
  "home.sessions.group.yesterday": "昨天",
  "home.sessions.group.older": "較早",
  "home.sessions.group.project": "{{project}} 工作階段",
  "home.sessions.liveBoard": "即時看板",
  "home.sessions.projectBoard": "{{project}} 工作階段",
  "home.sessions.projectScope": "只顯示 {{project}}",
  "home.sessions.showAllProjects": "所有專案",
  "home.metrics.projects.detail": "可用",
  "home.metrics.liveSessions": "即時工作階段",
  "home.metrics.liveSessions.detail": "進行中",
  "home.metrics.liveSessions.detail.idle": "閒置",
  "home.metrics.activeGoals": "活動目標",
  "home.metrics.activeGoals.detail": "執行中",
  "home.metrics.activeGoals.detail.idle": "無執行中目標",
  "home.metrics.needsAttention": "待處理",
  "home.metrics.needsAttention.detail": "排隊中",
  "home.metrics.needsAttention.detail.clear": "無提醒",
  "home.actions.title": "控制台",
  "home.actions.subtitle": "搜尋、跳轉和常用操作都在這裡。",
  "home.actions.quickAccess": "快速入口",
  "home.actions.search": "搜尋工作階段",
  "home.actions.search.detail": "快速找到最近的任一工作階段。",
  "home.actions.newSession": "新增工作階段",
  "home.actions.newSession.detail": "在目前選取的專案中開始。",
  "home.actions.resumeLast": "恢復上次",
  "home.actions.resumeLast.detail": "回到最近的活動工作階段。",
  "home.actions.openGoal": "開啟目標",
  "home.actions.openGoal.detail": "跳到最新的活動目標。",
  "home.actions.openGoal.disabled": "工作階段有活動目標時可用。請先新增或恢復工作階段並設定目標。",
  "home.actions.openProject": "開啟專案",
  "home.actions.openProject.detail": "新增或切換工作目錄。",
  "home.actions.settings": "設定",
  "home.actions.settings.detail": "模型、供應商與桌面行為。",
  "home.goals.empty": "暫無活動目標。請先新增或恢復工作階段並設定目標。",
  "home.attention.title": "待處理佇列",
  "home.attention.subtitle": "等待你處理的工作階段與目標。",
  "home.attention.queued": "排隊中",
  ...
  "session.goal.chainBuilder.shortTitle": "鏈",
  "session.goal.chainBuilder.sectionHint": "編排執行順序",
  "session.goal.chainBuilder.planChainHint": "從庫中新增動作；啟動後鏈條由上而下執行。",
  ...
  "session.goal.chainBuilder.currentStep": "目前步驟",
  "session.goal.chainBuilder.currentStepAria": "目前第 {{current}} / {{total}} 步",
  "session.goal.chainBuilder.budget.ready": "未超限",
  "session.goal.chainBuilder.budget.turnsOver": "回合超限",
  "session.goal.chainBuilder.budget.timeOver": "時間超限",
  "session.goal.chainBuilder.budget.bothOver": "回合和時間超限",
  "session.goal.chainBuilder.budget.readyDetail": "步驟預算在主鏈限制內。",
  ...
  "session.goal.error.corrupt.hint": "目標狀態檔可能已損毀。使用下方按鈕可在不離開側邊面板的情況下重置。",
  "session.goal.error.corrupt.reset": "重置並重新讀取",
  "session.goal.controlsHint": "開啟工作階段即可控制目標，也可使用聊天命令：/goal pause · /goal resume · /goal clear",
  "session.goal.create.submit": "啟動目標",
  "session.goal.create.quickHint": "啟動上方目標。",
  "session.goal.create.waiting": "等待輸入",
  "session.goal.create.fieldHint": "立即啟動。鏈目標在鏈建構器中設定。",
  ...
  "session.goal.terminal.startAgainHint": "在下方輸入新目標即可重新開始。",
  "session.goal.terminal.subtitleAchieved": "{{elapsed}} 內達成",
  "session.goal.terminal.subtitleCleared": "{{elapsed}} 後取消",
  "session.goal.steer.failed": "Steering was saved, but the prompt injection did not reach the session.",
  "session.goal.run.deliveryFailed": "已儲存，但執行提示未送達工作階段——目標已暫停。點擊恢復以重試。",
  "session.goal.composerBadge.running": "目標執行中",
  "session.goal.composerBadge.paused": "目標已暫停",
  "session.goal.composerBadge.stalled": "目標已停滯",
  "session.goal.composerBadge.idle": "設定目標",
  "session.goal.composerBadge.idleHint": "開啟 AutoGoal 面板為此工作階段設定目標",
  ...
  "session.goal.activity.empty": "等待第一個活動事件。",
  "session.goal.template.libraryShortTitle": "操作",
  "session.goal.template.librarySubtitle": "可重用庫",
  "session.goal.template.editorShortTitle": "編輯器",
  "session.goal.template.editorSubtitle": "編輯可重用操作。",
  "session.goal.template.pinnedAgent": "智能體",
  "session.goal.template.sessionDefaultAgent": "使用工作階段預設智能體",
  "session.goal.template.addSkill": "新增技能",
  "session.goal.template.removeSkill": "移除 {{skill}}",
  "session.goal.template.disabled.busy": "請等待目前目標操作完成。",
  "session.goal.template.disabled.missingSession": "先開啟一個工作階段，再編輯操作。",
  "session.goal.template.disabled.missingPrompt": "請輸入指令後再儲存或複製此操作。",
  "session.goal.template.disabled.noTemplate": "請選取一個專案操作後再刪除。",
  "session.goal.template.disabled.builtinTemplate": "內建操作已鎖定。請先複製，再編輯或刪除專案副本。",
  "session.goal.template.skillPicker.noSkills": "此操作沒有更多可用技能。",
  "session.goal.template.skillPicker.maxSkills": "此操作已達到 {{count}} 個技能上限。",
  "session.goal.chainBuilder.disabled.missingSession": "先開啟一個工作階段，再啟動鏈。",
  "session.goal.chainBuilder.startTitle": "驗證並啟動此鏈。",
  "session.goal.backendUnreachable": "無法連接 OpenCode 後端。連線恢復前，目標狀態可能已過期。",
  "session.goal.progress": "Progress",
  "session.goal.runControls": "Run Controls",
  "session.goal.diagnostics.title": "控制診斷",
  "session.goal.diagnostics.subtitle": "顯示控制項可用、被阻止或隱藏的原因。",
  "session.goal.diagnostics.command": "命令",
  "session.goal.diagnostics.unknownControl": "控制項",
  "session.goal.diagnostics.ready": "已就緒。",
  "session.goal.diagnostics.state.available": "就緒",
  "session.goal.diagnostics.state.blocked": "已阻止",
  "session.goal.diagnostics.state.busy": "忙碌",
  "session.goal.diagnostics.state.hidden": "隱藏",
  "session.goal.diagnostics.reason.busy": "另一個目標操作正在執行。",
  "session.goal.diagnostics.reason.missingSession": "請先開啟工作階段再使用此控制項。",
  "session.goal.diagnostics.reason.missingObjective": "請輸入目標或新增鏈動作。",
  "session.goal.diagnostics.reason.liveGoal": "已有即時目標正在執行。請先暫停、停止或完成它。",
  "session.goal.diagnostics.reason.pendingHandoff": "已有待處理交接。請先領取或清除它。",
  "session.goal.diagnostics.effect.startGoal": "寫入目標狀態，然後啟動一次助理回合。",
  "session.goal.diagnostics.effect.startChain": "寫入有序鏈，並啟動第一個可執行步驟。",
  "session.goal.diagnostics.effect.checkChain": "驗證本地執行順序，不啟動回合。",
  "session.goal.diagnostics.effect.copyReport": "將目前執行報告複製到剪貼簿。",
  "session.goal.diagnostics.effect.pause": "暫停 AutoGoal 並中止目前回合。",
  "session.goal.diagnostics.effect.resume": "繼續目標並推動工作階段前進。",
  "session.goal.diagnostics.effect.stop": "清除即時目標並中止工作階段樹。",
  "session.goal.diagnostics.effect.restart": "從已儲存狀態重新執行目前目標。",
  "session.goal.diagnostics.effect.steer": "向目前執行注入指引。",
  "session.goal.diagnostics.effect.handoff": "保存上下文以供新的後續工作階段使用。",
  "session.goal.diagnostics.effect.reset": "清除即時目標、鏈、交接和活動狀態。",
  "session.goal.constraints": "Constraints",
  "session.goal.verifyCommand": "Verify Command",
  "session.goal.recentRuns": "Recent Runs",
  "session.goal.chainBuilder.emptyChainDesc": "不需要鏈項目。開始目標直接運行上方目標；只有需要序列時才添加動作。",
  "session.goal.chainBuilder.emptyChainNote": "鏈項目編輯保持本地。重排、刪除、回合、分鐘、提示和命令的編輯在啟動鏈之前不會開始回合。",
  "session.goal.chainBuilder.stalledIdleMinutes": "閒置 {{minutes}} 分鐘。",
  "session.goal.chainBuilder.stepTurns": "回合",
  "session.goal.chainBuilder.stepMinutes": "分鐘",
  "session.goal.chainBuilder.moveUp": "上移",
  "session.goal.chainBuilder.moveDown": "下移",
  "session.goal.chainBuilder.stepRemove": "移除",
  "session.goal.chainBuilder.stepRemovePending": "移除待執行步驟",
  "session.goal.chainBuilder.stepRemoveLocked": "執行中或已完成的步驟會鎖定，直到鏈停止。",
  "session.goal.chainBuilder.addDisabledRunning": "停止正在執行的鏈後才能編輯草稿",
  "session.goal.chainBuilder.stepEditAria": "編輯 {{label}}",
  "session.goal.chainBuilder.stepTurnsAria": "{{label}} 的回合數",
  "session.goal.chainBuilder.stepMinutesAria": "{{label}} 的分鐘數",
  "session.goal.chainBuilder.check": "檢查",
  "session.goal.template.libraryHint": "加號添加到運行順序。編輯打開編輯器。",
  "session.goal.template.detailsHeader": "詳情",
  "session.goal.template.saveFailed": "儲存失敗 — 檢查會話或重試",
  "session.goal.template.builtinHidden": "內建操作已從此工作階段隱藏。",
  "session.goal.template.sessionDefaultModelFallback": "會話預設模型",
  "session.goal.template.noPinnedSkills": "未固定技能",
  "session.goal.template.skillCount": "{{count}} 個技能",
  "session.goal.runtime.agent": "代理",
  "session.goal.runtime.model": "模型",
  "session.goal.runtime.skills": "技能",
  "session.goal.runtime.completion": "完成條件",
  "session.goal.activity.showAll": "顯示全部",
  "session.goal.activity.showRecent": "顯示最近",
  "session.goal.chainBuilder.clearDraft": "清除鏈",
  "session.goal.chainBuilder.clearDraftHint": "從鏈建構器中移除所有草稿步驟。",
  "session.goal.action.confirmReset": "確認重置",
  "session.goal.action.confirmResetHint": "這將清除當前目標、鏈、交接和活動。模板和歷史記錄保留。",
  "session.goal.evidence.title": "最近評估",
  "session.goal.evidence.met": "已達成",
  "session.goal.evidence.notMet": "未達成",
  "session.goal.evidence.blocked": "已阻塞",
  "session.goal.evidence.history": "評估歷史",
  "session.goal.evidence.trend": "信心趨勢",
  "session.goal.steering.title": "引導筆記",
  "session.goal.velocity.unit": "輪/分",
  "session.goal.eta.label": "預計",
  "session.goal.report.copy": "複製報告",
  "session.goal.report.copied": "已複製！",
  "session.goal.terminal.consumed": "已消耗",
  "session.goal.terminal.cycles": "週期",
  "session.goal.terminal.finalEval": "最終評估",
  "session.goal.health.healthy": "健康",
  "session.goal.health.fair": "一般",
  "session.goal.health.risk": "風險",
  "session.goal.shortcuts.title": "鍵盤快捷鍵",
  "session.goal.shortcuts.pauseResume": "暫停 / 繼續",
  "session.goal.shortcuts.closePanel": "關閉面板",
  "session.goal.shortcuts.showHelp": "顯示幫助",
  "session.goal.smart.blocked": "目標被阻塞 — 考慮調整方向",
  "session.goal.smart.critical": "接近資源限制",
  "session.goal.smart.declining": "置信度下降 — 可能需要調整",
  "session.goal.smart.improving": "置信度提升中",
  "session.goal.smart.stalled": "目標似乎停滯 — 最近無活動",
  "session.goal.smart.paused": "目標已暫停",
  "session.goal.smart.starting": "開始評估",
  "session.goal.smart.running": "正常運行",
  "session.goal.stats.tokensPerTurn": "令牌/輪",
  "session.goal.stats.tokensPerMin": "令牌/分",
  "session.goal.stats.sinceEval": "距評估",
  "session.goal.stats.peakConf": "峰值",
  "session.goal.stats.delta": "變化",
  "session.goal.stats.successRate": "成功率",
  "session.goal.stats.streakMet": "達成",
  "session.goal.stats.streakNotMet": "未達",
  "session.goal.stats.volatility": "波動性",
  "session.goal.stats.avgCycle": "平均週期",
  "session.goal.stats.tokenExhaust": "令牌耗盡",
  "session.goal.stats.turnsLeft": "剩餘輪次",
  "session.goal.stats.timeLeft": "剩餘時間",
  "session.goal.stats.timeOver": "超出時間",
  "session.goal.stats.tokensLeft": "剩餘令牌",
  "session.goal.lastResult": "上次結果",
  "session.goal.action.pause": "暫停",
  "session.goal.action.resume": "繼續",
  "session.goal.action.restart": "重新開始",
  "session.goal.action.clear": "清除",
  "session.goal.action.confirmClear": "確認清除",
  "session.goal.action.cancel": "取消",
  "session.goal.create.title": "新目標",
  "session.goal.create.hint": "立即啟動目標。鏈從鏈建構器啟動。",
  "session.goal.create.condition": "目標條件",
  "session.goal.create.conditionPlaceholder": "代理應完成什麼？例如：所有測試通過",
  "session.goal.create.command": "Shell 驗證命令",
  "session.goal.create.commandPlaceholder": "可選的 shell 命令，例如：npm test",
  "session.goal.create.templates": "動作庫",
  "session.goal.chainBuilder.title": "鏈建構器",
  "session.goal.chainBuilder.subtitle": "將動作編排為執行序列",
  "session.goal.chainBuilder.stalledButton": "等待中",
  "session.goal.chainBuilder.stalledHint": "未偵測到近期活動。",
  "session.goal.chainBuilder.path": "將動作編排為執行序列",
  "session.goal.chainBuilder.planChain": "執行順序",
  "session.goal.chainBuilder.start": "啟動鏈",
  "session.goal.chainBuilder.autosave": "草稿已自動儲存",
  ...
  "session.goal.chainBuilder.steps": "步驟",
  "session.goal.template.path": "可重複使用的動作",
  "session.goal.template.search": "搜尋動作",
  "session.goal.template.searchPlaceholder": "搜尋動作",
  "session.goal.template.empty": "沒有符合的動作",
  "session.goal.template.draftOnly": "動作草稿",
  "session.goal.template.newDraft": "新增動作草稿",
  "session.goal.template.newDraftHint": "建構或儲存可重複使用的動作。",
  "session.goal.template.editorTitle": "動作編輯器",
  "session.goal.template.activeLibrary": "庫",
  "session.goal.template.activeLibraryHint": "儲存會更新該可重複使用的動作。",
  "session.goal.template.activeRunStep": "執行順序",
  "session.goal.template.activeRunStepHint": "更新列會修改所選的鏈節點。",
  "session.goal.template.new": "新增",
  "session.goal.template.label": "動作名稱",
  "session.goal.template.labelPlaceholder": "建構",
  "session.goal.template.prompt": "指令",
  "session.goal.template.command": "Shell 驗證命令",
  "session.goal.template.completionShell": "當 shell 命令以 0 結束時完成",
  "session.goal.template.completionMarker": "當代理回報完成時完成",
  "session.goal.template.constraints": "限制",
  "session.goal.template.variables": "變數",
  "session.goal.template.category": "類別",
  "session.goal.template.runtimePins": "執行時固定項",
  "session.goal.template.runtimePinsHint": "為此動作選擇代理、技能與模型",
  "session.goal.template.pinnedModel": "模型",
  "session.goal.template.pinnedSkills": "技能",
  "session.goal.template.sessionDefaultModel": "使用工作階段預設模型",
  "session.goal.template.noSkills": "此工作區中沒有可用的技能。",
  "session.goal.template.savedPin": "已儲存的固定項",
  "session.goal.template.unavailablePins": "此工作階段中不可用的已儲存執行時固定項：{{pins}}。",
  "session.goal.template.unavailableAgentPin": "智能體",
  "session.goal.template.unavailableModelPin": "模型",
  "session.goal.template.unavailableSkillPins": "技能 {{skills}}",
  "session.goal.template.edit": "編輯動作",
  "session.goal.template.editRunStep": "編輯執行順序中的動作",
  "session.goal.template.addToChain": "新增至執行順序",
  "session.goal.template.updateRunStep": "更新列",
  "session.goal.template.duplicate": "複製",
  "session.goal.template.delete": "刪除",
  "session.goal.template.saveName": "動作 ID",
  "session.goal.template.savePlaceholder": "my-custom-action",
  "session.goal.template.save": "儲存動作",
  "session.goal.budget.editTurns": "編輯回合數上限",
  "session.goal.budget.editTime": "編輯時間上限",
  "session.goal.budget.turnsLabel": "最大回合數",
  "session.goal.budget.timeLabel": "最大分鐘數",
  "session.goal.budget.save": "儲存",
  "session.goal.action.steer": "引導",
  "session.goal.action.newGoal": "新增目標",
  "session.goal.activity.title": "活動",
  "session.goal.history.title": "歷史",
  "session.goal.history.reuse": "重複使用目標",
  "session.goal.history.generate": "產生範本",
  "session.goal.steps.title": "目標鏈",
  "session.goal.steps.done": "完成",
  "session.goal.steps.add": "新增",
  "session.goal.steps.addAction": "新增步驟",
  "session.goal.steps.placeholder": "描述下一個鏈式目標…",
  "session.goal.steps.empty": "在此新增方法提示或自訂目標，依序執行。",
  "session.goal.steps.status.done": "已完成",
  "session.goal.steps.status.current": "目前",
  "session.goal.steps.status.queued": "排隊中",
  "session.goal.action.stop": "停止",
  "session.goal.action.confirmStop": "確認停止",
  "session.goal.interrupt.pausePermission": "已暫停目標並中止目前回合。有權限請求待處理；繼續前請解決或關閉它。",
  "session.goal.interrupt.stopPermission": "已停止目標並中止目前回合。有權限請求待處理，可能仍需解決或關閉。",
  "session.goal.interrupt.pauseQuestion": "已暫停目標並中止目前回合。有問題請求待處理；繼續前請回答或關閉它。",
  "session.goal.interrupt.stopQuestion": "已停止目標並中止目前回合。有問題請求待處理，可能仍需回答或關閉。",
  "session.goal.steer.placeholder": "為代理的下一步新增提示…",
  "session.goal.steer.hint": "在不清除或重新啟動鏈的情況下，為本次執行注入引導。",
  "session.goal.steer.send": "傳送",
  "session.goal.handoff.placeholder": "給下一位操作者的選填備註…",
  "session.goal.handoff.liveRunPending": "目前執行進行中。清除即時目標後即可認領。",
  "session.goal.handoff.age": "建立於 {{age}}",
  "session.goal.handoff.fromSession": "來自 {{session}}",
  "session.goal.handoff.resumesChain": "將恢復一個 {{total}} 步的鏈。",
  "session.goal.handoff.staleWarn": "此交接已等待較長時間。恢復前請確認。",
  "session.goal.handoff.claimConfirm": "仍然認領",
  ...
  "deeplink.confirm.title": "從外部連結打開專案",
  "deeplink.confirm.single": "一個外部連結想要打開專案：",
  "deeplink.confirm.multi": "一個外部連結想要打開 {count} 個專案：",
