export const dict = {
  ...
  "session.goal.commandStrip.hint": "Pause, steer, restart, stop, or open a new goal without leaving this dock.",
  ...
  "session.goal.create.command": "Verify command",
  "session.goal.create.commandPlaceholder": "Optional verify command, e.g. npm test",
  ...
  "session.goal.template.command": "Verify command",
  ...
  "session.goal.handoff.explain": "Save the current goal for a clean follow-up session. Claim opens a fresh session with the repo, goal state, limits, note, and latest evidence loaded.",
