...
export const dict = {
  ...
  "prompt.toast.abortFailed.title": "停止会话失败",
  ...
  "home.project.newSessionIn": "在 {{project}} 中新建会话",
  "home.sessions.search.placeholder": "搜索最近会话",
  "home.sessions.search.sessions": "会话",
  "home.sessions.search.noResults": "未找到与 {{query}} 相关的会话",
  "home.sessions.empty": "未找到会话",
  "home.sessions.empty.description": "为这个项目开始新的会话",
  "home.sessions.group.today": "今天",
  "home.sessions.group.yesterday": "昨天",
  "home.sessions.group.older": "更早",
  "home.sessions.group.project": "{{project}} 会话",
  "home.sessions.liveBoard": "实时看板",
  "home.sessions.projectBoard": "{{project}} 会话",
  "home.sessions.projectScope": "仅显示 {{project}}",
  "home.sessions.showAllProjects": "所有项目",
  "home.metrics.projects.detail": "可用",
  "home.metrics.liveSessions": "实时会话",
  "home.metrics.liveSessions.detail": "进行中",
  "home.metrics.liveSessions.detail.idle": "空闲",
  "home.metrics.activeGoals": "活动目标",
  "home.metrics.activeGoals.detail": "运行中",
  "home.metrics.activeGoals.detail.idle": "无运行目标",
  "home.metrics.needsAttention": "待处理",
  "home.metrics.needsAttention.detail": "排队中",
  "home.metrics.needsAttention.detail.clear": "无提醒",
  "home.actions.title": "控制台",
  "home.actions.subtitle": "搜索、跳转和常用操作都在这里。",
  "home.actions.quickAccess": "快速入口",
  "home.actions.search": "搜索会话",
  "home.actions.search.detail": "快速找到最近的任意会话。",
  "home.actions.newSession": "新建会话",
  "home.actions.newSession.detail": "在当前所选项目中开始。",
  "home.actions.resumeLast": "恢复上次",
  "home.actions.resumeLast.detail": "回到最近的活动会话。",
  "home.actions.openGoal": "打开目标",
  "home.actions.openGoal.detail": "跳到最新的活动目标。",
  "home.actions.openGoal.disabled": "当会话有活动目标时可用。请先新建或恢复会话并设置目标。",
  "home.actions.openProject": "打开项目",
  "home.actions.openProject.detail": "添加或切换工作目录。",
  "home.actions.settings": "设置",
  "home.actions.settings.detail": "模型、提供商和桌面行为。",
  "home.goals.empty": "暂无活动目标。请先新建或恢复会话并设置目标。",
  "home.attention.title": "待处理队列",
  "home.attention.subtitle": "等待你处理的会话和目标。",
  "home.attention.queued": "排队中",
  ...
  "session.goal.chainBuilder.shortTitle": "链",
  "session.goal.chainBuilder.sectionHint": "编排运行顺序",
  "session.goal.chainBuilder.planChainHint": "从库中添加动作；启动后链条自上而下运行。",
  ...
  "session.goal.chainBuilder.budget.bothOver": "轮次和时间超限",
  "session.goal.chainBuilder.budget.readyDetail": "步骤预算在主链限制内。",
  ...
  "session.goal.create.fieldHint": "立即启动。链目标在链构建器中设置。",
  ...
  "session.goal.run.deliveryFailed": "已保存，但运行提示未送达会话——目标已暂停。点击恢复以重试。",
  "session.goal.composerBadge.running": "目标运行中",
  "session.goal.composerBadge.paused": "目标已暂停",
  "session.goal.composerBadge.stalled": "目标已停滞",
  "session.goal.composerBadge.idle": "设置目标",
  "session.goal.composerBadge.idleHint": "打开 AutoGoal 面板为此会话设置目标",
  ...
  "session.goal.activity.empty": "等待第一个活动事件。",
  "session.goal.template.libraryShortTitle": "操作",
  "session.goal.template.librarySubtitle": "可复用库",
  "session.goal.template.editorShortTitle": "编辑器",
  "session.goal.template.editorSubtitle": "编辑可复用操作。",
  "session.goal.template.pinnedAgent": "智能体",
  "session.goal.template.sessionDefaultAgent": "使用会话默认智能体",
  "session.goal.template.addSkill": "添加技能",
  "session.goal.template.removeSkill": "移除 {{skill}}",
  "session.goal.template.disabled.busy": "请等待当前目标操作完成。",
  "session.goal.template.disabled.missingSession": "先打开一个会话，再编辑操作。",
  "session.goal.template.disabled.missingPrompt": "请输入指令后再保存或复制此操作。",
  "session.goal.template.disabled.noTemplate": "请选择一个项目操作后再删除。",
  "session.goal.template.disabled.builtinTemplate": "内置操作已锁定。请先复制，再编辑或删除项目副本。",
  "session.goal.template.skillPicker.noSkills": "此操作没有更多可用技能。",
  "session.goal.template.skillPicker.maxSkills": "此操作已达到 {{count}} 个技能上限。",
  "session.goal.chainBuilder.disabled.missingSession": "先打开一个会话，再启动链。",
  "session.goal.chainBuilder.startTitle": "验证并启动此链。",
  "session.goal.backendUnreachable": "无法连接 OpenCode 后端。连接恢复前，目标状态可能已过期。",
  "session.goal.progress": "Progress",
  "session.goal.runControls": "Run Controls",
  "session.goal.diagnostics.title": "控制诊断",
  "session.goal.diagnostics.subtitle": "显示控件可用、被阻止或隐藏的原因。",
  "session.goal.diagnostics.command": "命令",
  "session.goal.diagnostics.unknownControl": "控件",
  "session.goal.diagnostics.ready": "已就绪。",
  "session.goal.diagnostics.state.available": "就绪",
  "session.goal.diagnostics.state.blocked": "已阻止",
  "session.goal.diagnostics.state.busy": "忙碌",
  "session.goal.diagnostics.state.hidden": "隐藏",
  "session.goal.diagnostics.reason.busy": "另一个目标操作正在运行。",
  "session.goal.diagnostics.reason.missingSession": "请先打开会话再使用此控件。",
  "session.goal.diagnostics.reason.missingObjective": "请输入目标或添加链动作。",
  "session.goal.diagnostics.reason.liveGoal": "已有实时目标正在运行。请先暂停、停止或完成它。",
  "session.goal.diagnostics.reason.pendingHandoff": "已有待处理交接。请先领取或清除它。",
  "session.goal.diagnostics.effect.startGoal": "写入目标状态，然后启动一次助手回合。",
  "session.goal.diagnostics.effect.startChain": "写入有序链，并启动第一个可运行步骤。",
  "session.goal.diagnostics.effect.checkChain": "验证本地运行顺序，不启动回合。",
  "session.goal.diagnostics.effect.copyReport": "将当前运行报告复制到剪贴板。",
  "session.goal.diagnostics.effect.pause": "暂停 AutoGoal 并中止当前回合。",
  "session.goal.diagnostics.effect.resume": "继续目标并推动会话前进。",
  "session.goal.diagnostics.effect.stop": "清除实时目标并中止会话树。",
  "session.goal.diagnostics.effect.restart": "从已保存状态重新运行当前目标。",
  "session.goal.diagnostics.effect.steer": "向当前运行注入指导。",
  "session.goal.diagnostics.effect.handoff": "保存上下文以便新的后续会话使用。",
  "session.goal.diagnostics.effect.reset": "清除实时目标、链、交接和活动状态。",
  "session.goal.constraints": "Constraints",
  "session.goal.verifyCommand": "Verify Command",
  "session.goal.recentRuns": "Recent Runs",
  "session.goal.chainBuilder.emptyChainDesc": "不需要链项目。开始目标直接运行上方目标；只有需要序列时才添加动作。",
  "session.goal.chainBuilder.emptyChainNote": "链项目编辑保持本地。重排、删除、回合、分钟、提示和命令的编辑在启动链之前不会开始回合。",
  "session.goal.chainBuilder.stalledIdleMinutes": "空闲 {{minutes}} 分钟。",
  "session.goal.chainBuilder.stepTurns": "回合",
  "session.goal.chainBuilder.stepMinutes": "分钟",
  "session.goal.chainBuilder.moveUp": "上移",
  "session.goal.chainBuilder.moveDown": "下移",
  "session.goal.chainBuilder.stepRemove": "移除",
  "session.goal.chainBuilder.stepRemovePending": "移除待执行步骤",
  "session.goal.chainBuilder.stepRemoveLocked": "运行中或已完成的步骤会锁定，直到链停止。",
  "session.goal.chainBuilder.addDisabledRunning": "停止正在运行的链后才能编辑草稿",
  "session.goal.chainBuilder.stepEditAria": "编辑 {{label}}",
  "session.goal.chainBuilder.stepTurnsAria": "{{label}} 的回合数",
  "session.goal.chainBuilder.stepMinutesAria": "{{label}} 的分钟数",
  "session.goal.chainBuilder.check": "检查",
  "session.goal.template.libraryHint": "加号添加到运行顺序。编辑打开编辑器。",
  "session.goal.template.detailsHeader": "详情",
  "session.goal.template.saveFailed": "保存失败 — 检查会话或重试",
  "session.goal.template.builtinHidden": "内置操作已从此会话隐藏。",
  "session.goal.template.sessionDefaultModelFallback": "会话默认模型",
  "session.goal.template.noPinnedSkills": "未固定技能",
  "session.goal.template.skillCount": "{{count}} 个技能",
  "session.goal.runtime.agent": "代理",
  "session.goal.runtime.model": "模型",
  "session.goal.runtime.skills": "技能",
  "session.goal.runtime.completion": "完成条件",
  "session.goal.activity.showAll": "显示全部",
  "session.goal.activity.showRecent": "显示最近",
  "session.goal.chainBuilder.clearDraft": "清除链",
  "session.goal.chainBuilder.clearDraftHint": "从链构建器中移除所有草稿步骤。",
  "session.goal.action.confirmReset": "确认重置",
  "session.goal.action.confirmResetHint": "这将清除当前目标、链、交接和活动。模板和历史记录保留。",
  "session.goal.evidence.title": "最近评估",
  "session.goal.evidence.met": "已达成",
  "session.goal.evidence.notMet": "未达成",
  "session.goal.evidence.blocked": "已阻塞",
  "session.goal.evidence.history": "评估历史",
  "session.goal.evidence.trend": "置信度趋势",
  "session.goal.steering.title": "引导笔记",
  "session.goal.velocity.unit": "轮/分",
  "session.goal.eta.label": "预计",
  "session.goal.report.copy": "复制报告",
  "session.goal.report.copied": "已复制！",
  "session.goal.terminal.consumed": "已消耗",
  "session.goal.terminal.cycles": "周期",
  "session.goal.terminal.finalEval": "最终评估",
  "session.goal.health.healthy": "健康",
  "session.goal.health.fair": "一般",
  "session.goal.health.risk": "风险",
  "session.goal.shortcuts.title": "键盘快捷键",
  "session.goal.shortcuts.pauseResume": "暂停 / 继续",
  "session.goal.shortcuts.closePanel": "关闭面板",
  "session.goal.shortcuts.showHelp": "显示帮助",
  "session.goal.smart.blocked": "目标被阻塞 — 考虑调整方向",
  "session.goal.smart.critical": "接近资源限制",
  "session.goal.smart.declining": "置信度下降 — 可能需要调整",
  "session.goal.smart.improving": "置信度提升中",
  "session.goal.smart.stalled": "目标似乎停滞 — 最近无活动",
  "session.goal.smart.paused": "目标已暂停",
  "session.goal.smart.starting": "开始评估",
  "session.goal.smart.running": "正常运行",
  "session.goal.stats.tokensPerTurn": "令牌/轮",
  "session.goal.stats.tokensPerMin": "令牌/分",
  "session.goal.stats.sinceEval": "距评估",
  "session.goal.stats.peakConf": "峰值",
  "session.goal.stats.delta": "变化",
  "session.goal.stats.successRate": "成功率",
  "session.goal.stats.streakMet": "达成",
  "session.goal.stats.streakNotMet": "未达",
  "session.goal.stats.volatility": "波动性",
  "session.goal.stats.avgCycle": "平均周期",
  "session.goal.stats.tokenExhaust": "令牌耗尽",
  "session.goal.stats.turnsLeft": "剩余轮次",
  "session.goal.stats.timeLeft": "剩余时间",
  "session.goal.stats.timeOver": "超出时间",
  "session.goal.stats.tokensLeft": "剩余令牌",
  "session.goal.lastResult": "上次结果",
  "session.goal.action.pause": "暂停",
  "session.goal.action.resume": "继续",
  "session.goal.action.restart": "重新开始",
  "session.goal.action.clear": "清除",
  "session.goal.action.confirmClear": "确认清除",
  "session.goal.action.cancel": "取消",
  "session.goal.create.title": "新目标",
  "session.goal.create.hint": "立即启动目标。链从链构建器启动。",
  "session.goal.create.condition": "目标条件",
  "session.goal.create.conditionPlaceholder": "代理应完成什么？例如：所有测试通过",
  "session.goal.create.command": "Shell 验证命令",
  "session.goal.create.commandPlaceholder": "可选的 shell 命令，例如：npm test",
  "session.goal.create.templates": "动作库",
  "session.goal.chainBuilder.title": "链构建器",
  "session.goal.chainBuilder.subtitle": "将动作编排为运行序列",
  "session.goal.chainBuilder.stalledButton": "等待中",
  "session.goal.chainBuilder.stalledHint": "未检测到近期活动。",
  "session.goal.chainBuilder.path": "将动作编排为运行序列",
  "session.goal.chainBuilder.planChain": "运行顺序",
  "session.goal.chainBuilder.start": "启动链",
  "session.goal.chainBuilder.autosave": "草稿已自动保存",
  ...
  "session.goal.chainBuilder.steps": "步骤",
  "session.goal.template.path": "可复用动作",
  "session.goal.template.search": "搜索动作",
  "session.goal.template.searchPlaceholder": "搜索动作",
  "session.goal.template.empty": "没有匹配的动作",
  "session.goal.template.draftOnly": "动作草稿",
  "session.goal.template.newDraft": "新建动作草稿",
  "session.goal.template.newDraftHint": "构建或保存可复用动作。",
  "session.goal.template.editorTitle": "动作编辑器",
  "session.goal.template.activeLibrary": "库",
  "session.goal.template.activeLibraryHint": "保存将更新该可复用动作。",
  "session.goal.template.activeRunStep": "运行顺序",
  "session.goal.template.activeRunStepHint": "更新行将修改所选的链节点。",
  "session.goal.template.new": "新建",
  "session.goal.template.label": "动作名称",
  "session.goal.template.labelPlaceholder": "构建",
  "session.goal.template.prompt": "指令",
  "session.goal.template.command": "Shell 验证命令",
  "session.goal.template.completionShell": "当 shell 命令以 0 退出时完成",
  "session.goal.template.completionMarker": "当代理报告完成时完成",
  "session.goal.template.constraints": "限制",
  "session.goal.template.variables": "变量",
  "session.goal.template.category": "类别",
  "session.goal.template.runtimePins": "运行时固定项",
  "session.goal.template.runtimePinsHint": "为此动作选择代理、技能和模型",
  "session.goal.template.pinnedModel": "模型",
  "session.goal.template.pinnedSkills": "技能",
  "session.goal.template.sessionDefaultModel": "使用会话默认模型",
  "session.goal.template.noSkills": "此工作区中没有可用的技能。",
  "session.goal.template.savedPin": "已保存的固定项",
  "session.goal.template.unavailablePins": "此会话中不可用的已保存运行时固定项：{{pins}}。",
  "session.goal.template.unavailableAgentPin": "智能体",
  "session.goal.template.unavailableModelPin": "模型",
  "session.goal.template.unavailableSkillPins": "技能 {{skills}}",
  "session.goal.template.edit": "编辑动作",
  "session.goal.template.editRunStep": "编辑运行顺序中的动作",
  "session.goal.template.addToChain": "添加到运行顺序",
  "session.goal.template.updateRunStep": "更新行",
  "session.goal.template.duplicate": "复制",
  "session.goal.template.delete": "删除",
  "session.goal.template.saveName": "动作 ID",
  "session.goal.template.savePlaceholder": "my-custom-action",
  "session.goal.template.save": "保存动作",
  "session.goal.budget.editTurns": "编辑轮次上限",
  "session.goal.budget.editTime": "编辑时间上限",
  "session.goal.budget.turnsLabel": "最大轮次",
  "session.goal.budget.timeLabel": "最大分钟数",
  "session.goal.budget.save": "保存",
  "session.goal.action.steer": "引导",
  "session.goal.action.newGoal": "新建目标",
  "session.goal.activity.title": "活动",
  "session.goal.history.title": "历史",
  "session.goal.history.reuse": "复用目标",
  "session.goal.history.generate": "生成模板",
  "session.goal.steps.title": "目标链",
  "session.goal.steps.done": "完成",
  "session.goal.steps.add": "添加",
  "session.goal.steps.addAction": "添加步骤",
  "session.goal.steps.placeholder": "描述下一个链式目标…",
  "session.goal.steps.empty": "在此添加方法提示或自定义目标，按顺序运行。",
  "session.goal.steps.status.done": "已完成",
  "session.goal.steps.status.current": "当前",
  "session.goal.steps.status.queued": "排队中",
  "session.goal.action.stop": "停止",
  "session.goal.action.confirmStop": "确认停止",
  "session.goal.interrupt.pausePermission": "已暂停目标并中止当前回合。有权限请求待处理；继续前请解决或关闭它。",
  "session.goal.interrupt.stopPermission": "已停止目标并中止当前回合。有权限请求待处理，可能仍需解决或关闭。",
  "session.goal.interrupt.pauseQuestion": "已暂停目标并中止当前回合。有问题请求待处理；继续前请回答或关闭它。",
  "session.goal.interrupt.stopQuestion": "已停止目标并中止当前回合。有问题请求待处理，可能仍需回答或关闭。",
  "session.goal.steer.placeholder": "为代理的下一步添加提示…",
  "session.goal.steer.hint": "在不清除或重启链的情况下，为本次运行注入引导。",
  "session.goal.steer.send": "发送",
  "session.goal.handoff.placeholder": "给下一位操作者的可选备注…",
  "session.goal.handoff.liveRunPending": "当前运行进行中。清除实时目标后即可认领。",
  "session.goal.handoff.age": "创建于 {{age}}",
  "session.goal.handoff.fromSession": "来自 {{session}}",
  "session.goal.handoff.resumesChain": "将恢复一个 {{total}} 步的链。",
  "session.goal.handoff.staleWarn": "此交接已等待较长时间。恢复前请确认。",
  "session.goal.handoff.claimConfirm": "仍然认领",
  ...
  "deeplink.confirm.title": "从外部链接打开项目",
  "deeplink.confirm.single": "一个外部链接想要打开项目：",
  "deeplink.confirm.multi": "一个外部链接想要打开 {count} 个项目：",
