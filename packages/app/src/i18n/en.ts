export const dict = {
  ...
  "session.goal.create.title": "Set a goal",
  "session.goal.create.hint": "OpenCode keeps working toward it until it's met.",
  "session.goal.create.condition": "Goal condition",
  "session.goal.create.conditionPlaceholder": "What should the agent work toward? e.g. all tests pass",
  ...
  "session.goal.create.submit": "Set Goal",
  "session.goal.create.quickHint": "Jump to the standalone goal form.",
