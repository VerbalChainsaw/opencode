export const dict = {
  ...
  "session.goal.action.claim": "Claim",
  ...
  "session.goal.handoff.send": "Create handoff",
  "session.goal.handoff.hint": "Save this run for another session without starting a new turn.",
