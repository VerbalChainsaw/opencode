...
describe("goal panel mission-control contracts", () => {
  ...
  test("playbook visual pass keeps chain rows dense and library chrome explicit", async () => {
    ...
    expect(src).toContain("grid-cols-[24px_32px_minmax(96px,1fr)_minmax(56px,68px)_minmax(128px,148px)_96px]")
    ...
    expect(src).toContain("flex min-w-[96px] shrink-0 items-center justify-end gap-1")
