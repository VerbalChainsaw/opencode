export const dict = {
  ...
  "session.goal.create.templates": "Method library",
  ...
  "session.goal.chainBuilder.emptyChain": "Pick actions from the library to build a chain.",
  "session.goal.chainBuilder.steps": "steps",
  "session.goal.template.path": "Reusable prompt methods",
  "session.goal.template.search": "Search methods",
  "session.goal.template.searchPlaceholder": "Search methods",
  "session.goal.template.empty": "No methods match",
  "session.goal.template.draftOnly": "Method draft",
  "session.goal.template.new": "Prompt method",
  "session.goal.template.label": "Method label",
  "session.goal.template.labelPlaceholder": "Build",
  "session.goal.template.prompt": "Prompt",
  ...
  "session.goal.template.gate": "Checkpoint",
  "session.goal.template.tone": "Color",
  "session.goal.template.elevation": "Elevation",
  "session.goal.template.edit": "Edit draft",
  "session.goal.template.apply": "Use as draft",
  "session.goal.template.addToChain": "Add to chain",
  "session.goal.template.duplicate": "Duplicate",
  "session.goal.template.delete": "Delete",
  "session.goal.template.noCommand": "No verify command",
  "session.goal.template.noLimits": "Default run limits",
  "session.goal.template.saveName": "Template name",
  "session.goal.template.savePlaceholder": "my-custom-method",
  "session.goal.template.save": "Save template",
