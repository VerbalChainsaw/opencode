export const dict = {
  ...
  "prompt.toast.abortFailed.title": "Failed to stop session",
  ...
  "home.title": "Home",
  "home.header.kicker": "Mission control",
  "home.header.title": "OpenCode",
  "home.header.edition": "Verbal Chainsaw Edition",
  "home.header.subtitle": "Projects, sessions, goals — one deck.",
  "home.header.localTime": "Local",
  "home.header.daemon": "Daemon",
  "home.header.mcp": "MCP",
  "home.projects": "Projects",
  "home.projects.running": "Running projects",
  "home.projects.pinned": "Pinned projects",
  "home.projects.recent": "Recent projects",
  "home.projects.emptyRunning": "Nothing is running yet.",
  "home.projects.emptyPinned": "Open projects become your pinned rail.",
  "home.projects.emptyRecent": "Open a project to populate the recent lane.",
  "home.projects.lastActive": "Last active {{time}}",
  "home.projects.badge.sessions": "{{count}} live",
  "home.projects.badge.goals": "{{count}} goals",
  "home.projects.badge.alerts": "{{count}} alerts",
  "home.projects.badge.diffs": "{{count}} diffs",
  "home.projects.badge.pinned": "Pinned",
  "home.projects.badge.new": "{{count}} new",
  "home.project.add": "Add project",
  "home.project.newSessionIn": "New session in {{project}}",
  "home.sessions.search.placeholder": "Search recent sessions",
  ...
  "home.sessions.empty.title": "Nothing live yet",
  "home.sessions.empty.copy": "Start a session, open a project, or resume a recent thread to bring the deck online.",
  "home.sessions.group.today": "Today",
  "home.sessions.group.yesterday": "Yesterday",
  "home.sessions.group.older": "Older",
  "home.sessions.group.project": "{{project}} sessions",
  "home.sessions.liveBoard": "Control deck",
  "home.sessions.projectBoard": "{{project}} control deck",
  "home.sessions.projectScope": "Showing only {{project}}",
  "home.sessions.showAllProjects": "All projects",
  "home.sessions.updated": "Updated {{time}}",
  "home.sessions.card.goal": "Goal",
  "home.sessions.card.goal.none": "No active goal attached",
  "home.sessions.card.last": "Last action",
  "home.sessions.card.model": "Agent",
  "home.sessions.card.model.pending": "Routing telemetry pending",
  "home.sessions.card.tokens": "{{count}} tokens",
  "home.sessions.card.tokens.pending": "Token meter pending",
  "home.sessions.card.action.resume": "Resume",
  "home.sessions.card.action.inspect": "Inspect",
  "home.sessions.card.action.stop": "Stop",
  "home.sessions.card.action.stop.pending": "Session stop controls are not wired here yet.",
  "home.metrics.projects.detail": "ready",
  "home.metrics.projects.secondary": "{{running}} running · {{pinned}} pinned",
  "home.metrics.liveSessions": "Live sessions",
  "home.metrics.liveSessions.detail": "working now",
  "home.metrics.liveSessions.detail.idle": "idle",
  "home.metrics.liveSessions.secondary": "{{waiting}} waiting · {{retrying}} retrying · {{total}} tracked",
  "home.metrics.activeGoals": "Active goals",
  "home.metrics.activeGoals.detail": "running",
  "home.metrics.activeGoals.detail.idle": "none running",
  "home.metrics.activeGoals.secondary": "{{blocked}} blocked",
  "home.metrics.needsAttention": "Attention",
  "home.metrics.needsAttention.detail": "queued",
  "home.metrics.needsAttention.detail.clear": "clear",
  "home.metrics.needsAttention.secondary": "{{approvals}} approvals · {{failures}} failures",
  "home.metrics.mcp": "MCP",
  "home.metrics.mcp.secondary": "{{failed}} down · {{degraded}} degraded",
  "home.metrics.mcp.empty": "No MCP telemetry yet",
  "home.metrics.routing": "Routing",
  "home.metrics.routing.secondary": "{{connected}} connected · {{total}} available",
  "home.actions.title": "Control deck",
  "home.actions.subtitle": "Search, jump, and launch without leaving the board.",
  "home.actions.quickAccess": "Quick access",
  "home.actions.search": "Search sessions",
  "home.actions.search.detail": "Jump to any recent thread fast.",
  "home.actions.newSession": "New session",
  "home.actions.newSession.detail": "Start in the selected project.",
  "home.actions.resumeLast": "Resume last",
  "home.actions.resumeLast.detail": "Return to the latest open thread.",
  "home.actions.openGoal": "Open goal",
  "home.actions.openGoal.detail": "Jump to the newest active goal.",
  ...
  "home.actions.openProject.detail": "Add or switch a working tree.",
  "home.actions.settings": "Settings",
  "home.actions.settings.detail": "Models, providers, and desktop behavior.",
  "home.quick.title": "Quick actions",
  "home.quick.subtitle": "Fast levers for the next useful move.",
  "home.quick.start": "Start session",
  "home.quick.start.detail": "Draft a new session in the selected project.",
  "home.quick.project": "Open project",
  "home.quick.project.detail": "Add or switch a working tree.",
  "home.quick.search": "Search sessions",
  "home.quick.search.detail": "Jump to any recent thread.",
  "home.quick.resume": "Resume recent",
  "home.quick.resume.detail": "Return to the latest active thread.",
  "home.quick.mcp": "Reconnect MCP",
  "home.quick.mcp.detail": "Open the settings lane to repair MCP.",
  "home.quick.scan": "Scan local processes",
  "home.quick.scan.detail": "Process telemetry hooks are ready for future local scanners.",
  "home.quick.logs": "View logs",
  "home.quick.logs.detail": "Desktop log hooks land here next.",
  "home.quick.placeholder": "Hook ready",
  "home.recent.title": "Recent threads",
  "home.recent.empty": "No recent threads yet.",
  "home.goals.empty": "No active goals right now. Start or resume a session to set one.",
  "home.attention.title": "Attention center",
  "home.attention.subtitle": "Approvals, failed work, stalled goals, and MCP trouble.",
  "home.attention.summary.approvals": "Approvals",
  "home.attention.summary.failures": "Failures",
  "home.attention.summary.stalled": "Stalled",
  "home.attention.summary.mcp": "MCP",
  "home.attention.queued": "Queued",
  "home.attention.empty": "No active issues. Use the quick actions to keep the deck warm.",
  ...
  "home.attention.action.open": "Open",
  "home.status.online": "online",
  "home.status.offline": "offline",
  "home.status.pending": "pending",
  "home.status.error": "error",
  "home.status.waiting": "waiting",
  "home.status.stalled": "stalled",
  "home.status.retrying": "retrying",
  ...
  "session.goal.lastEvaluation": "Last evaluation",
  "session.goal.lastResult": "Last result",
  "session.goal.runningStatus": "Running status",
  "session.goal.runningStatus.hint": "Live goal state, budgets, and latest evidence.",
  "session.goal.runningStatus.latestEvidence": "Latest evidence",
  "session.goal.commandStrip.hint": "Lifecycle controls stay visible; Steer, Handoff, and Stop open here.",
  "session.goal.metric.status": "Status",
  "session.goal.metric.turns": "Turns",
  "session.goal.metric.time": "Time",
  "session.goal.metric.chain": "Chain",
  "session.goal.metric.commands": "Commands",
  "session.goal.metric.tokens": "Tokens",
  "session.goal.metric.remaining": "remaining",
  "session.goal.history": "History",
  "session.goal.history.empty": "none yet",
  "session.goal.error.corrupt": "Could not read goal state",
  "session.goal.error.corrupt.hint":
    "The goal state file may be corrupted. Use the button below to reset it without leaving the side panel.",
  "session.goal.error.corrupt.reset": "Reset and re-read",
  "session.goal.controlsHint":
    "Open a session to control the goal, or use chat: /goal pause · /goal resume · /goal clear",
  "session.goal.action.pause": "Pause",
  "session.goal.action.resume": "Resume",
  "session.goal.action.restart": "Restart",
  "session.goal.action.clear": "Clear",
  "session.goal.action.confirmClear": "Confirm clear",
  "session.goal.action.cancel": "Cancel",
  "session.goal.create.title": "New goal",
  "session.goal.create.hint": "Start a goal immediately. Chains start from the chain builder.",
  "session.goal.create.condition": "Goal condition",
  "session.goal.create.conditionPlaceholder": "What should the agent accomplish? e.g. all tests pass",
  "session.goal.create.command": "Shell verification command",
  "session.goal.create.commandPlaceholder": "Optional shell command, e.g. npm test",
  "session.goal.create.submit": "Start goal",
  "session.goal.create.quickHint": "Start the goal above.",
  "session.goal.create.waiting": "Waiting for input",
  "session.goal.create.fieldHint": "Starts immediately. Chain targets are set in the Chain Builder.",
  "session.goal.create.templates": "Action library",
  "session.goal.chainBuilder.title": "Chain builder",
  "session.goal.chainBuilder.subtitle": "Compose actions into a run sequence",
  "session.goal.chainBuilder.runningTitle": "Running chain",
  "session.goal.chainBuilder.runningSubtitle": "Current step is highlighted. Controls and activity stay here.",
  "session.goal.chainBuilder.runningButton": "Running",
  "session.goal.chainBuilder.stalledButton": "Waiting",
  "session.goal.chainBuilder.stalledHint": "No recent activity detected.",
  "session.goal.chainBuilder.pausedTitle": "Paused chain",
  "session.goal.chainBuilder.pausedSubtitle": "Paused at the highlighted step. Resume continues from here.",
  "session.goal.chainBuilder.pausedButton": "Paused",
  "session.goal.chainBuilder.completedButton": "Completed",
  "session.goal.chainBuilder.stoppedButton": "Stopped",
  "session.goal.chainBuilder.runningHeader": "Running order",
  "session.goal.chainBuilder.shortTitle": "Chain",
  "session.goal.chainBuilder.sectionHint": "Build run order",
  "session.goal.chainBuilder.path": "Compose actions into a run sequence",
  "session.goal.chainBuilder.planChain": "Run order",
  "session.goal.chainBuilder.planChainHint": "Add actions from the library; start chain runs top to bottom.",
  "session.goal.chainBuilder.start": "Start chain",
  "session.goal.chainBuilder.validate": "Validate chain",
  "session.goal.chainBuilder.saveDraft": "Save draft",
  "session.goal.chainBuilder.autosave": "Draft autosaved",
  ...
  "session.goal.chainBuilder.stat.commands": "Commands",
  "session.goal.chainBuilder.stat.turnsHint": "max",
  "session.goal.chainBuilder.stat.timeHint": "minutes",
  "session.goal.chainBuilder.stat.actionsHint": "chain points",
  ...
  "session.goal.chainBuilder.budget.bothOver": "Turns + time over",
  "session.goal.chainBuilder.budget.readyDetail": "Step budgets fit within the master chain limits.",
  "session.goal.chainBuilder.masterTurns": "Master turns",
  "session.goal.chainBuilder.masterMinutes": "Master minutes",
  "session.goal.chainBuilder.emptyChain": "No actions yet. Use Add in the library.",
  "session.goal.chainBuilder.steps": "steps",
  "session.goal.chainBuilder.disabled.missingSession": "Open a session before starting a chain.",
  "session.goal.chainBuilder.startTitle": "Validate and start this chain.",
  "session.goal.template.path": "Reusable actions",
  "session.goal.template.search": "Search actions",
  "session.goal.template.searchPlaceholder": "Search actions",
  "session.goal.template.empty": "No actions match",
  "session.goal.template.libraryShortTitle": "Actions",
  "session.goal.template.librarySubtitle": "Reusable library",
  "session.goal.template.draftOnly": "Action draft",
  "session.goal.template.newDraft": "New action draft",
  "session.goal.template.newDraftHint": "Build or save a reusable action.",
  "session.goal.template.editorTitle": "Action editor",
  "session.goal.template.editorShortTitle": "Editor",
  "session.goal.template.editorSubtitle": "Edit reusable actions.",
  "session.goal.template.activeLibrary": "Library",
  "session.goal.template.activeLibraryHint": "Save updates the reusable action.",
  "session.goal.template.activeRunStep": "Run order",
  "session.goal.template.activeRunStepHint": "Update row changes the selected chain point.",
  "session.goal.template.new": "New",
  "session.goal.template.label": "Action name",
  "session.goal.template.labelPlaceholder": "Build",
  "session.goal.template.prompt": "Instruction",
  "session.goal.template.command": "Shell verification command",
  "session.goal.template.completionShell": "Completes when the shell command exits 0",
  "session.goal.template.completionMarker": "Completes when the agent reports completion",
  "session.goal.template.constraints": "Limits",
  "session.goal.template.variables": "Variables",
  "session.goal.template.category": "Category",
  "session.goal.template.runtimePins": "Runtime pins",
  "session.goal.template.runtimePinsHint": "Pick the agent, skills, and model for this action",
  "session.goal.template.pinnedAgent": "Agent",
  "session.goal.template.pinnedModel": "Model",
  "session.goal.template.pinnedSkills": "Skills",
  "session.goal.template.sessionDefaultAgent": "Use session default agent",
  "session.goal.template.sessionDefaultModel": "Use session default model",
  "session.goal.template.noSkills": "No skills are available in this workspace.",
  "session.goal.template.addSkill": "Add skill",
  "session.goal.template.removeSkill": "Remove {{skill}}",
  "session.goal.template.disabled.busy": "Wait for the current goal operation to finish.",
  "session.goal.template.disabled.missingSession": "Open a session before editing actions.",
  "session.goal.template.disabled.missingPrompt": "Enter an instruction before saving or duplicating this action.",
  "session.goal.template.disabled.noTemplate": "Select a project action before deleting.",
  "session.goal.template.disabled.builtinTemplate":
    "Built-in actions are locked. Duplicate one to edit or delete a project copy.",
  "session.goal.template.skillPicker.noSkills": "No more skills are available for this action.",
  "session.goal.template.skillPicker.maxSkills": "This action already has the maximum of {{count}} skills.",
  "session.goal.template.savedPin": "Saved pin",
  "session.goal.template.unavailablePins": "Saved runtime pins unavailable in this session: {{pins}}.",
  "session.goal.template.unavailableAgentPin": "agent",
  "session.goal.template.unavailableModelPin": "model",
  "session.goal.template.unavailableSkillPins": "skills {{skills}}",
  "session.goal.template.edit": "Edit action",
  "session.goal.template.editRunStep": "Edit run-order action",
  "session.goal.template.addToChain": "Add to run order",
  "session.goal.template.updateRunStep": "Update row",
  "session.goal.template.duplicate": "Duplicate",
  "session.goal.template.delete": "Delete",
  "session.goal.template.saveName": "Action ID",
  "session.goal.template.savePlaceholder": "my-custom-action",
  "session.goal.template.save": "Save action",
  "session.goal.budget.editTurns": "Edit the turn limit",
  "session.goal.budget.editTime": "Edit the time limit",
  "session.goal.budget.turnsLabel": "Max turns",
  "session.goal.budget.timeLabel": "Max minutes",
  "session.goal.budget.maxTokensLabel": "Max tokens",
  "session.goal.budget.usedTokensLabel": "Used tokens",
  ...
  "session.goal.activity.empty": "Waiting for the first activity event.",
  "session.goal.history.title": "History",
  "session.goal.history.reuse": "Reuse goal",
  "session.goal.history.generate": "Generate template",
  "session.goal.history.archivedRuns": "{{count}} archived runs",
  "session.goal.history.details": "Archived run details",
  "session.goal.history.outcome": "Outcome",
  "session.goal.history.turns": "Turns",
  "session.goal.history.turnCount": "{{count}} turns",
  "session.goal.history.evaluated": "evaluated",
  "session.goal.history.elapsed": "Elapsed",
  "session.goal.history.runtime": "runtime",
  "session.goal.history.passed": "Passed",
  "session.goal.history.failed": "Failed",
  "session.goal.history.notMet": "not met",
  "session.goal.history.latestReason": "Latest reason",
  "session.goal.steps.title": "Goal chain",
  "session.goal.steps.done": "complete",
  "session.goal.steps.add": "Add",
  "session.goal.steps.addAction": "Add step",
  "session.goal.steps.placeholder": "Describe the next chained goal…",
  "session.goal.steps.empty": "Add method prompts or custom goals here to run them in order.",
  "session.goal.steps.status.done": "Done",
  "session.goal.steps.status.current": "Current",
  "session.goal.steps.status.queued": "Queued",
  "session.goal.action.stop": "Stop",
  "session.goal.action.confirmStop": "Confirm stop",
  "session.goal.interrupt.pausePermission":
    "Paused the goal and aborted the active turn. A permission prompt was pending; resolve or dismiss it before resuming.",
  "session.goal.interrupt.stopPermission":
    "Stopped the goal and aborted the active turn. A permission prompt was pending and may still need to be resolved or dismissed.",
  "session.goal.interrupt.pauseQuestion":
    "Paused the goal and aborted the active turn. A question prompt was pending; answer or dismiss it before resuming.",
  "session.goal.interrupt.stopQuestion":
    "Stopped the goal and aborted the active turn. A question prompt was pending and may still need to be answered or dismissed.",
  "session.goal.action.handoff": "Handoff",
  "session.goal.action.claim": "Claim in new session",
  "session.goal.action.resetState": "Reset state",
  "session.goal.action.resetStateHint":
    "Clear live goal, chain, handoff, and activity state while keeping templates and history.",
  ...
  "session.goal.run.deliveryFailed":
    "Saved, but the run prompt didn't reach the session — the goal was paused. Resume to retry.",
  "session.goal.composerBadge.running": "Goal running",
  "session.goal.composerBadge.paused": "Goal paused",
  "session.goal.composerBadge.stalled": "Goal stalled",
  "session.goal.composerBadge.idle": "Set goal",
  "session.goal.composerBadge.idleHint": "Open the AutoGoal panel to set a goal for this session",
  "session.goal.handoff.placeholder": "Optional note for the next operator…",
  ...
  "session.goal.handoff.corrupt":
    "A handoff file exists but could not be read. Run doctor or remove the corrupt handoff before claiming.",
  ...
  "session.goal.diagnostics.title": "Control Diagnostics",
  "session.goal.diagnostics.subtitle": "Shows why controls are available, blocked, or hidden before you click.",
  "session.goal.diagnostics.command": "Command",
  "session.goal.diagnostics.unknownControl": "Control",
  "session.goal.diagnostics.ready": "Ready.",
  "session.goal.diagnostics.state.available": "Ready",
  "session.goal.diagnostics.state.blocked": "Blocked",
  "session.goal.diagnostics.state.busy": "Busy",
  "session.goal.diagnostics.state.hidden": "Hidden",
  "session.goal.diagnostics.reason.busy": "Another goal operation is running.",
  "session.goal.diagnostics.reason.missingSession": "Open a session before using this control.",
  "session.goal.diagnostics.reason.missingObjective": "Enter a goal objective or add a chain action.",
  "session.goal.diagnostics.reason.liveGoal":
    "A live goal is already running. Pause, stop, or finish it before starting another.",
  "session.goal.diagnostics.reason.pendingHandoff":
    "A handoff is already pending. Claim or clear it before saving another.",
  "session.goal.diagnostics.effect.startGoal": "Writes the goal state, then starts one assistant turn.",
  "session.goal.diagnostics.effect.startChain": "Writes the ordered chain and starts the first runnable step.",
  "session.goal.diagnostics.effect.checkChain": "Validates the local run order without starting a turn.",
  "session.goal.diagnostics.effect.copyReport": "Copies the current run report to the clipboard.",
  "session.goal.diagnostics.effect.pause": "Pauses AutoGoal and aborts the active turn.",
  "session.goal.diagnostics.effect.resume": "Resumes the goal and nudges the session forward.",
  "session.goal.diagnostics.effect.stop": "Clears the live goal and aborts the session tree.",
  "session.goal.diagnostics.effect.restart": "Re-runs the current goal from its saved state.",
  "session.goal.diagnostics.effect.steer": "Injects guidance into the active run.",
  "session.goal.diagnostics.effect.handoff": "Saves context for a fresh follow-up session.",
  "session.goal.diagnostics.effect.reset": "Clears live goal, chain, handoff, and activity state.",
  "session.goal.constraints": "Constraints",
  "session.goal.verifyCommand": "Verify Command",
  "session.goal.recentRuns": "Recent Runs",
  "session.goal.chainBuilder.emptyChainDesc":
    "No chain items are required. Start Goal runs the goal above; add actions only when this goal needs a sequence.",
  "session.goal.chainBuilder.emptyChainNote":
    "Chain item edits stay local. Reorder, remove, turns, minutes, prompt, and command edits do not start a turn until Start Chain.",
  "session.goal.chainBuilder.stalledIdleMinutes": "{{minutes}}m idle.",
  "session.goal.chainBuilder.stepTurns": "Turns",
  "session.goal.chainBuilder.stepMinutes": "Min",
  "session.goal.chainBuilder.check": "Check",
  "session.goal.chainBuilder.moveUp": "Move up",
  "session.goal.chainBuilder.moveDown": "Move down",
  "session.goal.chainBuilder.stepRemove": "Remove",
  "session.goal.chainBuilder.stepRemovePending": "Remove pending step",
  "session.goal.chainBuilder.stepRemoveLocked": "Running or completed steps are locked until the chain stops.",
  "session.goal.chainBuilder.addDisabledRunning": "Stop the running chain to edit the draft",
  "session.goal.backendUnreachable":
    "Cannot reach the OpenCode backend. Goal state may be stale until the connection recovers.",
  ...
  "session.goal.template.libraryHint": "Plus adds to Run Order. Edit opens the editor.",
  "session.goal.template.detailsHeader": "Details",
  "session.goal.template.saveFailed": "Save failed — check session or retry",
  "session.goal.template.builtinHidden": "Built-in action hidden from this session.",
  "session.goal.template.sessionDefaultModelFallback": "Session default model",
  "session.goal.template.noPinnedSkills": "No pinned skills",
  "session.goal.template.skillCount": "{{count}} skills",
  "session.goal.runtime.agent": "Agent",
  "session.goal.runtime.model": "Model",
  "session.goal.runtime.skills": "Skills",
  "session.goal.runtime.completion": "Completion",
  "session.goal.activity.showAll": "Show all",
  "session.goal.activity.showRecent": "Show recent",
  "session.goal.chainBuilder.clearDraft": "Clear chain",
  "session.goal.chainBuilder.clearDraftHint": "Remove all draft steps from the chain builder.",
  "session.goal.action.confirmReset": "Confirm reset",
  "session.goal.action.confirmResetHint":
    "This clears the live goal, chain, handoff, and activity. Templates and history are kept.",
  "session.goal.evidence.title": "Last Evaluation",
  "session.goal.evidence.met": "Met",
  "session.goal.evidence.notMet": "Not met",
  "session.goal.evidence.blocked": "Blocked",
  "session.goal.evidence.history": "Evaluation History",
  "session.goal.evidence.trend": "Confidence trend",
  "session.goal.steering.title": "Steering Notes",
  "session.goal.velocity.unit": "t/min",
  "session.goal.eta.label": "ETA",
  "session.goal.report.copy": "Copy report",
  "session.goal.report.copied": "Copied!",
  "session.goal.terminal.consumed": "consumed",
  "session.goal.terminal.cycles": "cycles",
  "session.goal.terminal.finalEval": "Final evaluation",
  "session.goal.health.healthy": "Healthy",
  "session.goal.health.fair": "Fair",
  "session.goal.health.risk": "At risk",
  "session.goal.shortcuts.title": "Keyboard Shortcuts",
  "session.goal.shortcuts.pauseResume": "Pause / Resume",
  "session.goal.shortcuts.closePanel": "Close panel",
  "session.goal.shortcuts.showHelp": "Show this help",
  "session.goal.smart.blocked": "Goal is blocked — consider steering",
  "session.goal.smart.critical": "Approaching resource limits",
  "session.goal.smart.declining": "Confidence declining — may need steering",
  "session.goal.smart.improving": "Confidence improving",
  "session.goal.smart.stalled": "Goal appears stalled — no recent activity",
  "session.goal.smart.paused": "Goal is paused",
  "session.goal.smart.starting": "Starting evaluation",
  "session.goal.smart.running": "Running normally",
  "session.goal.stats.tokensPerTurn": "tok/turn",
  "session.goal.stats.tokensPerMin": "tok/min",
  "session.goal.stats.sinceEval": "since eval",
  "session.goal.stats.peakConf": "peak",
  "session.goal.stats.delta": "delta",
  "session.goal.stats.successRate": "success",
  "session.goal.stats.streakMet": "met",
  "session.goal.stats.streakNotMet": "not met",
  "session.goal.stats.volatility": "volatility",
  "session.goal.stats.avgCycle": "avg cycle",
  "session.goal.stats.tokenExhaust": "tokens exhaust",
  "session.goal.stats.turnsLeft": "turns left",
  "session.goal.stats.timeLeft": "time left",
  "session.goal.stats.timeOver": "time over",
  "session.goal.stats.tokensLeft": "tokens left",
  ...
  "deeplink.confirm.title": "Open project from external link",
  "deeplink.confirm.single": "An external link wants to open a project:",
  "deeplink.confirm.multi": "An external link wants to open {count} projects:",
